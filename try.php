        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    <?php
                  $select_posts_result = select_news("ORDER BY news_date DESC LIMIT 6");
                  ...
                  while ($row = $select_posts_result->fetch_assoc()) {
                    ...
                    <div class="blog-pagination">
                        ...
                        <?php 
                        //  $query = $select_posts_result;
                        //  $pr_results = mysqli_query($connection, $query);
                        //  $totalRecords = mysqli_num_rows($pr_results);
